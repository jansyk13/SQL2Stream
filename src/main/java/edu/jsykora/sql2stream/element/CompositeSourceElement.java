...
public final class CompositeSourceElement<E> extends SourceElement<E> {
    ...
    public static <E> CompositeSourceElement<E> createCompositeSourceElement(InputContainer<E> container, String alias, SourceElement<?> next) {
