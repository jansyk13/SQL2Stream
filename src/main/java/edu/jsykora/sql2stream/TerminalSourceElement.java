...
final class TerminalSourceElement<E> extends SourceElement<E> {

    private TerminalSourceElement(Iterable<E> iterable, String alias, Class<E> clazz) {
	super(iterable, alias, clazz);
    }

    protected static <E> TerminalSourceElement<E> createTerminalSourceElement(InputContainer<E> container, String alias) {
